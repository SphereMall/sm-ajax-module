...
var AjaxElement = /** @class */ (function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var AjaxFormElement_1 = __webpack_require__(5);
var AjaxHtmlElement_1 = __webpack_require__(6);
var AjaxElementFactory = /** @class */ (function () {
...
var AjaxFormElement = /** @class */ (function (_super) {
    ...
    AjaxFormElement.prototype.subscribe = function () {
        var validator = new Validator_1.Validator(this.element);
        var buttons = this.element.querySelectorAll('button, input[type="submit"]');
...
Object.defineProperty(exports, "__esModule", { value: true });
var AjaxElement_1 = __webpack_require__(0);
var AjaxHtmlElement = /** @class */ (function (_super) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var IsValidationElementSpecification = /** @class */ (function () {
    function IsValidationElementSpecification() {
    }
    IsValidationElementSpecification.prototype.IsSatisfiedBy = function (candidate) {
        return candidate.tagName == 'INPUT';
    };
    return IsValidationElementSpecification;
}());
exports.IsValidationElementSpecification = IsValidationElementSpecification;
...
var IsValidationElementSpecification_1 = __webpack_require__(7);
var Validator = /** @class */ (function () {
    ...
    Validator.prototype.init = function () {
        var _this = this;
        var isValidationEl = new IsValidationElementSpecification_1.IsValidationElementSpecification();
        Object.keys(this.form.childNodes).forEach(function (key) {
            var element = _this.form.childNodes[+key];
            if (isValidationEl.IsSatisfiedBy(element) && element.getAttribute('name')) {
                _this.rules[element.getAttribute('name')] = {
                    presence: true,
                    length: {
                        minimum: 2,
...
(function(exports, module, define) {
  ...
  validate.exposeModule(validate, this, exports, module, __webpack_require__(1));
}).call(this,
...
var AjaxElementFactory_1 = __webpack_require__(2);
var Settings_1 = __webpack_require__(4);
var AjaxModule = /** @class */ (function () {
    function AjaxModule() {
        this.elements = [];
    }
